...
class PeopleResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PeopleResp', createEmptyInstance: create)
    ..pc<Person>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'people', $pb.PbFieldType.PM, subBuilder: Person.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PeopleResp.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PeopleResp.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PeopleResp clone() => PeopleResp()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PeopleResp copyWith(void Function(PeopleResp) updates) => super.copyWith((message) => updates(message as PeopleResp)) as PeopleResp; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PeopleResp create() => PeopleResp._();
  PeopleResp createEmptyInstance() => create();
  static $pb.PbList<PeopleResp> createRepeated() => $pb.PbList<PeopleResp>();
  @$core.pragma('dart2js:noInline')
  static PeopleResp getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PeopleResp>(create);
  static PeopleResp? _defaultInstance;
